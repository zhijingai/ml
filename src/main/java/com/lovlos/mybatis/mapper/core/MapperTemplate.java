...
public abstract class MapperTemplate {
	 ...
	 * <p>
	 * String类型：
	 * <code>&lt;if test="property!=null and property!=''"&gt;columnNode&lt;/if&gt;</code>
	 * </p>
	 * 
	 * @param column
	 * @return
	 ...
	 * <p>
	 * String类型：
	 * <code>&lt;if test="property==null or property==''"&gt;columnNode&lt;/if&gt;</code>
	 * </p>
	 * 
	 * @param column
	 * @return
	...
	protected SqlNode getIfCacheNotNull(EntityHelper.EntityColumn column,
		...
		if (column.getJavaType().equals(String.class)) {
			return new IfSqlNode(columnNode, column.getProperty()
					+ "_cache != null and " + column.getProperty()
					+ "_cache != '' ");
		}
		return new IfSqlNode(columnNode, column.getProperty()
				+ "_cache != null ");
	 ...
	 * <p>
	 * String类型：
	 * <code>&lt;if test="property_cache!=null and property_cache!=''"&gt;columnNode&lt;/if&gt;</code>
	 * </p>
	 * 
	 * @param column
	 * @return
	...
	protected SqlNode getIfCacheIsNull(EntityHelper.EntityColumn column,
		...
		if (column.getJavaType().equals(String.class)) {
			return new IfSqlNode(columnNode, column.getProperty()
					+ "_cache == null or " + column.getProperty()
					+ "_cache == '' ");
		}
		return new IfSqlNode(columnNode, column.getProperty()
				+ "_cache == null ");
	...
	protected void newSelectKeyMappedStatement(MappedStatement ms,
		...
		ParameterMap.Builder inlineParameterMapBuilder = new ParameterMap.Builder(
				configuration, statementBuilder.id() + "-Inline", entityClass,
				parameterMappings);
		statementBuilder.parameterMap(inlineParameterMapBuilder.build());
		List<ResultMap> resultMaps = new ArrayList<ResultMap>();
		ResultMap.Builder inlineResultMapBuilder = new ResultMap.Builder(
				configuration, statementBuilder.id() + "-Inline", column.getJavaType(),
		...
		MappedStatement keyStatement = configuration.getMappedStatement(keyId,
				false);
		configuration.addKeyGenerator(keyId, new SelectKeyGenerator(
				keyStatement, executeBefore));
		// keyGenerator
		try {
			MetaObject msObject = forObject(ms);
			msObject.setValue("keyGenerator",
					configuration.getKeyGenerator(keyId));
		} catch (Exception e) {
			// ignore
		}
	}
